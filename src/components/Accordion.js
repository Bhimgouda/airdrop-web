...
const Accordion = () => {
  ...
  const ELIGIBILITY_CRITERIA = [
    ...
    },
    {
      ...
      id: "phone_no",
      sucessMessage: [
        `Points earned: ${points.phone_no}`,
        "Description: You've have verified phone number",
      ],
    ...
    },
    {
      ...
      id: "validator_nodes",
      sucessMessage: [
        `Points earned: ${points.validator_nodes}`,
        `Description: You have hosted ${points.validator_nodes / 10} unique nodes`,
      ],
    ...
    },
    {
      ...
      sucessMessage: [
        `Points earned: ${points.validator_nodes_may}`,
        `Description: You've have hosted ${
          points.validator_nodes / 10
        } unique nodes since May 2022`,
      ],
    ...
    },
    {
      ...
      id: "twitter",
      sucessMessage: [
        `Points earned: ${points.twitter}`,
        `Description: You've earned Level ${points.twitter / 10} staus in our Twitter Community`,
      ],
      failureMessage: [
        "Points earned: 0",
        "Description: You've not earned any level in our Twitter Community",
      ],
    },
    {
      ...
      id: "telegram",
      sucessMessage: [
        `Points earned: ${points.telegram}`,
        `Description: You've earned Level ${points.telegram / 10} staus in our Telegram Community`,
      ],
      failureMessage: [
        "Points earned: 0",
        "Description: You've not earned any level in our Telegram Community",
      ],
      dataPoints: ["Telegram"],
    },
    {
      ...
      id: "discord",
      sucessMessage: [
        `Points earned: ${points.discord}`,
        `Description: You've earned Level ${points.discord / 10} staus in our Discord Community`,
      ],
      failureMessage: [
        "Points earned: 0",
        "Description: You've not earned any level in our Discord Community",
      ],
      dataPoints: ["Discord"],
    },
    {
      criteria: "You have signed transactions on our Testnet",
      id: "interactions",
      sucessMessage: [
        `Points earned: ${points.interactions}`,
        `Description: You've made ${points.interactions / 5} interaction on our testnet`,
      ],
      failureMessage: [
        "Points earned: 0",
        "Description: You'v not made any interaction on our testnet",
      ],
    },
    {
      ...
      id: "kramaId",
      sucessMessage: [
        `Points earned: ${points.kramaIds}`,
        `Description: You've have ${points.kramaIds / 10} Krama Ids`,
      ],
    ...
    },
    {
      ...
      id: "createdApp",
      sucessMessage: [
        `Points earned: ${points.createdApp}`,
        "Description: You've created atleast one app",
      ],
    ...
    },
    {
      ...
      id: "partApp",
      sucessMessage: [
        `Points earned: ${points.partApp}`,
        `Description: You've used ${points.partApp / 5} apps`,
      ],
    ...
    },
    {
      ...
      id: "createdAvatar",
      sucessMessage: [
        `Points earned: ${points.createdAvatar}`,
        `Description: You've created an ${points.createdAvatar / 10} avatar`,
      ],
    ...
    },
    {
      ...
      id: "scannedAvatar",
      sucessMessage: [
        `Points earned: ${points.scannedAvatar}`,
        "Description: Your avatar is scanned atleast once",
      ],
        ...
        return (
          <div key={index}>
            ...
            >
                ...
                <div className="flex items-center py-4">
                  <div className="text-green-300 pr-3">
                    {!moiState[item.id] ? (
                      ...
                      <svg
                        className="w-5 h-5 mr-1.5 text-green-600 flex-shrink-0"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
              ...
              <div>
                <button className="text-xl font-bold">{activeIndex === index ? "-" : "+"}</button>
              </div>
            </div>
            {activeIndex === index && (
              <ul className="max-w-md pl-14 space-y-1 list-disc list-outside">
                {moiState[item.id]
                  ? item.sucessMessage.map((data, index) => (
                      <li
                        key={index}
                        className={`text-[14px] font-normal ${
                          isDarkMode ? "text-moi-black-300" : "text-moi-white-300"
                        }`}
                      >
                        {data}
                      </li>
                    ))
                  : item.failureMessage.map((data, index) => (
                      <li
                        key={index}
                        className={`text-[14px] font-normal ${
                          isDarkMode ? "text-moi-black-300" : "text-moi-white-300"
